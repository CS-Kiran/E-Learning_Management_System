...
<div class="panel panel-default" style="margin-top:50px">
  <div class="panel-body">
    <h3>Q & A forum</h3>
    <hr>
    <form name="frm" method="post" action="/Project/QA/save.php">
        <input type="hidden" id="commentid" name="Pcommentid" value="0">
	<div class="form-group">
		<h2><?php
            //$name=pg_escape_string($con,$_REQUEST['name']);
						echo $_SESSION['name'];
            //echo $_SESSION['name'];
				?>
		</h2>
      ...
      <?php
        ...
        if(pg_num_rows($e)>0)
        {
          while($row=pg_fetch_array($e))
          {
            $_SESSION['n']=$row['name'];
            $_SESSION['q']=$row['post'];
            $_SESSION['qno']=$row['qid'];
            echo "<h4 style='position:absolute;'>".$_SESSION['qno']."&nbsp&nbsp::&nbsp&nbsp" .$_SESSION['n']. "&nbsp&nbsp&nbsp::&nbsp&nbsp&nbsp&nbsp&nbsp" .$_SESSION['q']."</h4>";
        ?>
        <div class="rp">

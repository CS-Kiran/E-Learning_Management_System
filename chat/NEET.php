<?php
    ...
    /*Attempt to Insert Query Execution*/
     ...
     $query="INSERT INTO neet(uname,msg,dt) VALUES ('$un','$m','$ts')"; 
...
<form id="myform" action="NEET.php" method="POST">
...
/* $query = "select * from chats;"; */
    ...
    $run=pg_query($con,"select * from neet");
    $i=0;

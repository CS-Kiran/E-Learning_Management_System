<?php
    ...
    /*Attempt to Insert Query Execution*/
     ...
     $query="INSERT INTO ugcnet(uname,msg,dt) VALUES ('$un','$m','$ts')"; 
...
<div id="container">
    <main>
        ...
        <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1940306/ico_star.png" alt="">
            ...
            <div><h2>WELCOME TO UGC NET CHATGROUP</h2></div>
...
<form id="myform" action="UGC NET.php" method="POST">
...
$con=pg_connect("host=localhost user=postgres dbname=postgres password=paswan9741");

/* $query = "select * from chats;"; */

    $run=pg_query($con,"select * from ugcnet");
    $i=0;

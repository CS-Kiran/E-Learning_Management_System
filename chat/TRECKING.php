<?php
    ...
    /*Attempt to Insert Query Execution*/
     ...
     $query="INSERT INTO treck(uname,msg,dt) VALUES ('$un','$m','$ts')"; 
...
<form id="myform" action="TRECKING.php" method="POST">
...
/* $query = "select * from chats;"; */
    ...
    $run=pg_query($con,"select * from treck");
    $i=0;

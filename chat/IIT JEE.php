<?php
    ...
    /*Attempt to Insert Query Execution*/
     ...
     $query="INSERT INTO iitjee(uname,msg,dt) VALUES ('$un','$m','$ts')"; 
...
/* $query = "select * from chats;"; */
    ...
    $run=pg_query($con,"select * from iitjee");
    $i=0;
...
?>
    ...
    <footer>
        <table>
            <tr>
                <th>
                    <input class="input1" type="text" id="uname" name="uname" placeholder="Your Name">
                </th>
